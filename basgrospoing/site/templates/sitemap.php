...
$templateignore = array('module.text','module.citation','module.largeimage','module.fullimage','module.imgleft','module.imgright','module.gallery'); // pages with template IN $templateignore are ignored
