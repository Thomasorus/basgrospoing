<div class="section-head">
    <span class="section-head__full-line">
        ...
        <svg height="16" width="90" id="78851d7d-8e78-4b60-aaed-7004f7dbc1ee" data-name="Calque 1"
            ...
            <defs>
                <style>
                    .f75bdb5a-a501-478a-bf5e-020a196fa933 {
                        fill: #010101
                    }
                </style>
            </defs>
            <title>bgp-wireframe-podcast</title>
            <path class="f75bdb5a-a501-478a-bf5e-020a196fa933"
    ...
    <h2 class="d-inline color-black text-shadow-green-xs text-transform-uppercase font-futura-bold-italic">
