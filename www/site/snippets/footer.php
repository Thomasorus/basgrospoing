<footer class="bg-black">
  <div class="[ footer ] [ grid-1-1-1-1 wrapper ]">
    <nav class="font-futura" aria-label="Main content and rss feeds menu">
      <ul role="list" class="flow-s1">
    ...
    <nav class="footer-list" aria-label="Secondary content menu">
    <ul role="list" class="flow-s1">
        <li>
...
<script>
  ...
  window.addEventListener('scroll', function (e) {
    var s = (window.pageYOffset !== undefined) ? window.pageYOffset : (document.documentElement || document.body
      .parentNode ||
